...
const NewsLatterBox = () => {
  ...
  return (
    <div
      className="wow fadeInUp shadow-three dark:bg-gray-dark relative z-10 rounded-xs bg-white p-8 sm:p-11 lg:p-8 xl:p-11"
      data-wow-delay=".2s"
    >
      ...
      <div>
        ...
        <input
          type="submit"
          value="Subscribe"
          className="shadow-submit dark:shadow-submit-dark mb-5 flex w-full cursor-pointer items-center justify-center rounded-xs bg-primary px-9 py-4 text-base font-medium text-white duration-300 hover:bg-primary/90"
        />
